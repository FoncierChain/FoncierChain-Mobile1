...
class ApiService {
  static String baseUrl =
      'https://foncierchain-web1.onrender.com'; // Use fixed URL for dev as requested

  static void setEnvironment(bool isPro) {
    if (isPro) {
      baseUrl = 'https://api-pro.foncierchain.cg';
    } else {
      baseUrl = 'https://foncierchain-web1.onrender.com';
    }
  }
  ...
  static Future<Map<String, dynamic>> _handleResponse(
    ...
    try {
      ...
      return {
        'status': 'FAILED',
        'message':
            'Problème de connexion internet ou serveur injoignable. Le système FoncierChain nécessite une connexion active.',
        'error': e.toString(),
        'is_offline': true
      };
    }
  ...
  static Future<Map<String, dynamic>> registerOfficial(
      Map<String, dynamic> data) async {
    return _handleResponse(http.post(
  ...
  static Future<Map<String, dynamic>> registerHeir(
      Map<String, dynamic> data) async {
    return _handleResponse(http.post(
  ...
  // --- Land workflow ---
  static Future<Map<String, dynamic>> signalFraud(
      Map<String, dynamic> data) async {
    return _handleResponse(http.post(
  ...
  static Future<Map<String, dynamic>> verifySurvey(String landId, String action,
      {String? reason}) async {
    return _handleResponse(http.post(
  ...
  static Future<Map<String, dynamic>> getPublicRegistry() async {
    try {
      final response =
          await http.get(Uri.parse('$baseUrl/api/v1/registry/public'));
      if (response.statusCode == 200) {
        return jsonDecode(response.body);
      }
    } catch (e) {
  ...
  static Future<Map<String, dynamic>> giveLocalAdvice(
      String landId, String comment, String action) async {
    return _handleResponse(http.post(
      Uri.parse('$baseUrl/api/v1/land/local-advice'),
      headers: {'Content-Type': 'application/json'},
      body:
          jsonEncode({'land_id': landId, 'comment': comment, 'action': action}),
    ));
  }

  static Future<Map<String, dynamic>> notaryValidate(
      String landId, String signature) async {
    return _handleResponse(http.post(
  ...
  static Future<Map<String, dynamic>> ministryApprove(
      String landId, String signature) async {
    return _handleResponse(http.post(
  ...
  static Future<Map<String, dynamic>> executeSale(
      String landId, String buyerUid, String buyerSignature) async {
    return _handleResponse(http.post(
  ...
  static Future<Map<String, dynamic>> reviewKYC(
      String username, String action) async {
    return _handleResponse(http.post(
  ...
  static Future<Map<String, dynamic>> verifyKYC(
      String entityId, String idNumber) async {
    return _handleResponse(http.post(
  ...
  static Future<Map<String, dynamic>> approveDraft(
      String landId, String action) async {
    return _handleResponse(http.post(
  ...
  static Future<Map<String, dynamic>> getPerformanceAudit() async {
    return _handleResponse(
        http.get(Uri.parse('$baseUrl/api/v1/land/performance-audit')));
  }

  static Future<Map<String, dynamic>> getLandHistory(String landId) async {
    return _handleResponse(
        http.get(Uri.parse('$baseUrl/api/v1/land/$landId/history')));
  }
  ...
  static Future<Map<String, dynamic>> openEscrow(
      String landId, double amount) async {
    return _handleResponse(http.post(
  ...
  static Future<Map<String, dynamic>> notifyHeritage(
      String landId, String deathCertId) async {
    return _handleResponse(http.post(
  ...
  static Future<Map<String, dynamic>> mutateLand(
      String landId, String newOwnerId) async {
    return _handleResponse(http.post(
  ...
  static Future<Map<String, dynamic>> submitOpposition(
      String landId, String reason, String proofHash) async {
    return _handleResponse(http.post(
      Uri.parse('$baseUrl/api/v1/land/oppose'),
      headers: {'Content-Type': 'application/json'},
      body: jsonEncode(
          {'land_id': landId, 'reason': reason, 'proof_hash': proofHash}),
    ));
  }

  static Future<Map<String, dynamic>> validateLand(
      String landId, String signature) async {
  ...
  static Future<Map<String, dynamic>> finalizeLand(
      String landId, String signature) async {
    return _handleResponse(http.patch(
  ...
  static Future<dynamic> citizenVerify(String query) async {
    try {
      final response = await http
          .get(Uri.parse('$baseUrl/api/v1/citizen/verify?land_id=$query'));
      return jsonDecode(response.body);
    } catch (e) {
